...
export const DeleteEvaluationModal = ({ show, evaluationId, onClose, trigger, setShow }) => {
  ...
  const handleDelete = async (e) => {
    ...
    try {
      ...
      console.log(err);
      message.error('Cannot delete this evaluation because it is referenced by another record.');
    }
  };
  ...
  return (
    <>
      <Modal show={show} onHide={onClose}>
        ...
        <Modal.Body>{`Are you sure you want to delete the evaluation ?`}</Modal.Body>
