  ...
  const columns = [
    ...
    },
    {
      ...
      render: (checked, record, index) => (
        <Checkbox checked={checked} onChange={(e) => handleCheckboxChange(e, index, 'checkbox1')} />
      ),
    },
    {
      title: 'No',
      ...
      key: 'checkbox2',
      render: (checked, record, index) => (
        <Checkbox checked={checked} onChange={(e) => handleCheckboxChange(e, index, 'checkbox2')} />
      ),
    },
    {
      title: 'Remarks',
      ...
      render: (text, record, index) => (
        <Input.TextArea rows={4} value={text} onChange={(e) => handleTextareaChange(e, index)} />
      ),
    },
  ];
