...
const EvaluateApplication4 = ({ handleReturn, handleNext }) => {
  ...
  const [dataSource, setDataSource] = useState([
    ...
    {
      key: '2b',
      text2: '2.b If yes, did the research paper obtain ethics clearance? (if applicable)',
      checkbox1: false,
      checkbox2: false,
      textarea: '',
    },
    ...
    {
      key: '5',
      text2: '5. Does the research paper have an overall score of at least 90% in grammarly?',
      checkbox1: false,
      checkbox2: false,
      textarea: '',
    },
      ...
      <Form>
        <Row>
          <Col style={{ marginLeft: '40px', marginTop: '0px' }}>
            <h2 className="titleFont p-2">III. Initial Research Ethics Review and Evaluation</h2>
            <h3 className="titleFont mb-0" style={{ fontSize: '17px', marginLeft: '10px' }}>
              Note: The Research Paper should satisfy ALL the applicable criteria.
            </h3>
          </Col>
        </Row>
      </Form>
