...
const IncentivesPage2 = ({
  ...
  const [formState, setFormState] = useState(formData || location.state?.formData || {});
  ...
  return (
    <Container fluid style={{ height: '100vh' }}>
      ...
      <Form>
        <Row className="mb-2" style={{ paddingLeft: '3rem', paddingRight: '3rem' }}>
          <Form.Group as={Col} xs lg="6">
            ...
            <p className="paragraph">Please attach the following forms and supporting documents:</p>
          </Form.Group>
          ...
          <Form.Group as={Col} xs lg="6">
            ...
            <div className="custom-file-input-wrapper">
              ...
              <label htmlFor="researchEvaluationForm" className="custom-file-label">
                {formatFilePath(selectedFiles['tip-aru-036']?.file_path) || 'Choose file'}
              </label>
            </div>
          </Form.Group>
          ...
          <Form.Group as={Col} xs lg="6">
            ...
            <div className="custom-file-input-wrapper">
              ...
              <label htmlFor="fullPaper" className="custom-file-label">
                {formatFilePath(selectedFiles['full paper']?.file_path) || 'Choose file'}
              </label>
            </div>
          </Form.Group>
        </Row>
          ...
          <Form.Group as={Col} xs lg="6">
            ...
            <div className="custom-file-input-wrapper">
              ...
              <label htmlFor="turnitin" className="custom-file-label">
                {formatFilePath(selectedFiles['turnitin']?.file_path) || 'Choose file'}
              </label>
            </div>
          </Form.Group>

          <Form.Group as={Col} xs lg="6">
            <Form.Label className="labelFont">Research Incentive Form (TIP - ARU - 028)</Form.Label>
            <div className="custom-file-input-wrapper">
              <input
                type="file"
              ...
              <label htmlFor="researchIncentiveForm" className="custom-file-label">
                {formatFilePath(selectedFiles['tip-aru-028']?.file_path) || 'Choose file'}
              </label>
            </div>
          </Form.Group>
        </Row>
          ...
          <Form.Group as={Col} xs lg="6">
            ...
            <div className="custom-file-input-wrapper">
              ...
              <label htmlFor="grammarly" className="custom-file-label">
                {formatFilePath(selectedFiles['grammarly']?.file_path) || 'Choose file'}
              </label>
            </div>
          </Form.Group>
      ...
      >
        <Button variant="outline-warning" as={Col} onClick={returnToCategoryPage}>
          Return
        </Button>
        <Col md="auto"></Col>
        {isEditMode ? (
