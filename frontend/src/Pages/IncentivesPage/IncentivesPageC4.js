        ...
        <Row className="mb-2" style={{ paddingLeft: '3rem', paddingRight: '3rem' }}>
          <Form.Group as={Col} xs lg="6">
            ...
            <p className="paragraph">
              ...
              Higher Education (CHED) per CHED Memorandum Order 10 s.2014 and other related issues.
            </p>
          </Form.Group>
          ...
          />
          <FileInput
            label="Screencap of Proof of National Refereed Journal"
            name="screencap_of_proof"
            value={selectedFiles['screencap of proof of national refereed journal']}
            onChange={handleChange}
            dataFileType="Screencap of Proof of National Refereed Journal"
            id="screencapOfProof"
            disabled={!isEditMode}
          />
        </Row>
...
export default IncentivesPageC4;
