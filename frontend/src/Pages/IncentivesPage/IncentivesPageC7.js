          ...
          <Form.Group as={Col} xs lg="6">
            ...
            <div className="custom-file-input-wrapper">
              ...
              <label htmlFor="citedTwoYears" className="custom-file-label">
                {formatFilePath(
                  selectedFiles['full paper (citing paper) published at most 2 years ago']
                    ?.file_path,
                ) || 'Choose file'}
              </label>
            </div>
          ...
          <Form.Group as={Col} xs lg="6" style={{ paddingTop: '3rem' }}>
            ...
            <div className="custom-file-input-wrapper">
              ...
              <label htmlFor="citedFiveYears" className="custom-file-label">
                {formatFilePath(
                  selectedFiles['full paper (cited) published at most 5 years ago']?.file_path,
                ) || 'Choose file'}
              </label>
            </div>
          </Form.Group>
          ...
          <Form.Group as={Col} xs lg="6">
            ...
            <div className="custom-file-input-wrapper">
              ...
              <label htmlFor="proofCitingPaper" className="custom-file-label">
                {formatFilePath(
                  selectedFiles['proof that citing paper is a national refereed journal']
                    ?.file_path,
                ) || 'Choose file'}
              </label>
            </div>
