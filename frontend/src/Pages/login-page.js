  ...
  return (
    <Form>
      ...
      <Form.Group controlId="formBasicDepartment">
        ...
        <Form.Select value={data.dept_id} onChange={(e) => setDept(e.target.value)}>
      ...
      <Form.Group controlId="formBasicRole">
        ...
        <Form.Select value={data.role} onChange={(e) => setRole(e.target.value)}>
  ...
  const handleSubmit = async (e) => {
    ...
    if (data.email !== '') {
      if (data.password !== '') {
        ...
        message.error('Password is empty or not valid (minimum of 8 characters).');
      }
    } else {
