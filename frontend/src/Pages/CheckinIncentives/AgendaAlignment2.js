...
const AgendaAlignment2 = ({
  ...
  const [dataSource, setDataSource] = useState([
    ...
    },
    {
      key: '2',
      text1: 'PROBLEM',
      text2: 'The problem statement is concrete and concise.',
      checkbox1: formData.is_problem1 === true,
      checkbox2: formData.is_problem1 === false,
      textarea: formData.is_problem1_remarks || '',
    },
    {
      key: '3',
      text1: 'PROBLEM',
      ...
      checkbox1: formData.is_problem2 === true,
      checkbox2: formData.is_problem2 === false,
      textarea: formData.is_problem2_remarks || '',
    },
    {
      key: '4',
      text1: 'SIGNIFICANCE OF THE STUDY',
      text2: 'The study has practical value to the researcher, the school or the community.',
      checkbox1: formData.is_significance1 === true,
      checkbox2: formData.is_significance1 === false,
      textarea: formData.is_significance1_remarks || '',
    },
    {
      key: '5',
      text1: 'SIGNIFICANCE OF THE STUDY',
      text2: 'The research findings are innovative and have practical applications.',
      checkbox1: formData.is_significance2 === true,
      checkbox2: formData.is_significance2 === false,
      textarea: formData.is_significance2_remarks || '',
    },
    {
      key: '6',
      text1: 'SIGNIFICANCE OF THE STUDY',
      text2: 'The research findings satisfy a specific knowledge gap.',
      checkbox1: formData.is_significance3 === true,
      checkbox2: formData.is_significance3 === false,
      textarea: formData.is_significance3_remarks || '',
    },
    {
      key: '7',
      text1: 'SIGNIFICANCE OF THE STUDY',
      text2: 'The research findings lead to an improvement in existing practice.',
      checkbox1: formData.is_significance4 === true,
      checkbox2: formData.is_significance4 === false,
      textarea: formData.is_significance4_remarks || '',
    },
  ]);
      ...
      <Form>
        <Row>
          <Col style={{ marginLeft: '40px', marginTop: '0px' }}>
            <h2 className="titleFont p-2">II. Research Components, Criteria, and Evaluation</h2>
          </Col>
        </Row>
      </Form>
...
export default AgendaAlignment2;
