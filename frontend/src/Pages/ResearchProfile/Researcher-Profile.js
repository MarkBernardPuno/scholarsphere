    ...
    return (
      <div>
        <Col>
          ...
          >
            <Image src={require('../../assets/images.png')} roundedCircle height={150} />
            {/* <div
            style={{
              display: "flex",
              ...
              {resultsItems.map((item, index) => (
                ...
                >
                  {index === 0 && (
                    ...
                    >
                      <h1 style={{ fontSize: '2rem', margin: '0' }}>{item.author_name}</h1>
                      <p
                        style={{
                          fontSize: '.9rem',
                          margin: '0',
        ...
        <table style={{ width: '100%' }}>
          ...
          <tbody>
            <tr>
              ...
              <td className="text-center citation-content" style={{ verticalAlign: 'right' }}>
                1234
              </td>
            </tr>
            <tr>
              ...
              <td className="text-center citation-content" style={{ verticalAlign: 'middle' }}>
                56
              </td>
              <td className="text-center citation-content" style={{ verticalAlign: 'right' }}>
                1234
