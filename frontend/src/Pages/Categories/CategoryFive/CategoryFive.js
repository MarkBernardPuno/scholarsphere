...
const CategoryFive = () => {
  ...
  const handleContinue = () => {
    ...
    console.log('formData.publication_date:', formData.publication_date); // Debug log
    console.log('selectedFiles.full_or_doi:', selectedFiles.full_or_doi); // Debug log
    console.log('selectedFiles.proof_peer_review:', selectedFiles.proof_peer_review); // Debug log
    console.log('selectedFiles.screencap_of_proof:', selectedFiles.screencap_of_proof); // Debug log
    console.log('selectedFiles.screencap_of_abstract:', selectedFiles.screencap_of_abstract); // Debug log
    console.log('selectedFiles.screencap_of_editorial:', selectedFiles.screencap_of_editorial); // Debug log
    console.log('selectedFiles.screencap_of_acceptance:', selectedFiles.screencap_of_acceptance); // Debug log
