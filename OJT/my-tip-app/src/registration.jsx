        ...
        <div style={S.authFormPanel}>
          <div style={{ ...S.authFormInner, maxWidth: '460px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }} onKeyDown={handleEnterSubmit}>
              ...
              <input style={S.inp} type="password" placeholder="Password" value={signupPass} onChange={e => setSignupPass(e.target.value)} />
              <input style={S.inp} type="password" placeholder="Repeat Password" value={repeatPass} onChange={e => setRepeatPass(e.target.value)} />
              <button
